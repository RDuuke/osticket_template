...
?>
<h1 class="title-arroba"><?php echo Format::display($title); ?></h1>
<p class="p-arroba"><?php echo Format::display($body); ?></p>
...
<div class="content-login">
    ...
    <p>
        <input class="btn-arroba-login" type="submit" value="<?php echo __('Sign In'); ?>">
